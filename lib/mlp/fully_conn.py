...
class TestFCGeLU(Module):
    def __init__(self, keep_prob=0, dtype=np.float32, seed=None):
        self.net = sequential(
            ...
            fc(input_dim=15, output_dim=5, init_scale=0.02, name="fc"),
            gelu(name="gelu")
            ########### END ###########
        )
...
class TinyNet(Module):
    def __init__(self, keep_prob=0, dtype=np.float32, seed=None):
        ...
        self.net = sequential(
            ########## TODO: ##########
            flatten(name="flatten"),
            fc(input_dim = 3072, output_dim = 300, init_scale = 0.02, name="fc1"),
            gelu(name="gelu"),
            fc(input_dim = 300, output_dim = 20, init_scale = 0.02, name="fc2"),
            ########### END ###########
        )
